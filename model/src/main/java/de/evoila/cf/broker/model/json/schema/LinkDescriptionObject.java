...
public class LinkDescriptionObject {
    ...
    public LinkDescriptionObject setHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinkDescriptionObject setRel(String rel) {
        this.rel = rel;
        return this;
    }
    ...
    public LinkDescriptionObject setMethod(String method) {
        this.method = method;
        return this;
    }
    ...
    public LinkDescriptionObject setEnctype(String enctype) {
    ...
    public LinkDescriptionObject setTargetSchema(JsonSchema targetSchema) {
    ...
    public LinkDescriptionObject setSchema(JsonSchema schema) {
    ...
    public LinkDescriptionObject setTitle(String title) {
    ...
    public LinkDescriptionObject setMediaType(String mediaType) {
